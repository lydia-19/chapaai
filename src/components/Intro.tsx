          ...
          <div className="flex h-full flex-col justify-center max-xl:gap-6">
            <div className="relative flex items-center justify-center md:py-10 xl:py-4">
              <div className="flex-1/2 md:flex-4/5">
                <div className="xl-2:w-lg xl-2:left-[42%] absolute top-0 left-[46%] aspect-square w-32 rounded-full backdrop-blur-[2px] md:w-72 md:backdrop-blur-xs lg:left-[42%] xl:left-[46%] xl:w-md 2xl:w-xl"></div>
